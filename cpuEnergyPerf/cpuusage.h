...
////////////////////////////////////////////////////////////////////////////////////
// Time the CPU gives to a process   
///////////////////////////////////////////////////////////////////////////////////
...
unsigned long long get_pid_cpu_time(int pid) { 

    /*This function returns the time the CPU gives to a process (PID) in kernel and user mode.
...
double get_pid_cpu_usage(int pid, int interval_ms) {
    ...
    /*This function calculates the percentage of processor usage in a time interval for a PID*/


    unsigned long long start_process_time = get_pid_cpu_time(pid);
    unsigned long long start_total_time = get_total_cpu_time();
    ...
    if(interval_ms>0){
        ...
        unsigned long long end_process_time = get_pid_cpu_time(pid);
