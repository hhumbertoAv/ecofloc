...
void calculate_power(int pid, int interval_milliseconds, int total_time_seconds,  StorageValues* s_values) {
    ...
    while ((total_time_seconds<0) || (current_time = time(NULL)) - start_time < total_time_seconds) {
